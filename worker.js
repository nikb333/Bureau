...
CRITICAL — PO Reference vs Invoice Number:
- po_reference must be a SHORT reference like "PO-211" or "PO-193". Extract the core PO number from longer strings.
  Common patterns: "HABU20260227HA211" → the PO number is 211, so po_reference = "PO-211". "GB-241" → po_reference = "PO-241". "E2501" → po_reference = "PO-2501".
  The number is typically the last few digits after a letter prefix (HA=Hecor, GB/US/CA/AU/E=Soundbox, BUR=Dawon).
  Format: "PO-" followed by the extracted number. Examples: HA211→"PO-211", HABU20260227HA211→"PO-211", GB241→"PO-241", BUR-005→"PO-005", E2501→"PO-2501".
- invoice_number should contain the FULL original reference string from the document (e.g. "HABU20260227HA211", "GB-241", "E2501").
  This preserves the complete document reference for traceability.
